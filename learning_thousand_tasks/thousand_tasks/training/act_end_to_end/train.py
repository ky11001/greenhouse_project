...
if __name__ == '__main__':
    ...
    try:
        for epoch in range(num_epochs):
            ...
            writer.add_scalar("Train/Trans_L1", avg_trans_loss, epoch)
            writer.add_scalar("Train/Trans_Error_mm", avg_trans_error_mm, epoch)
            writer.add_scalar("Train/Rot_Error_deg", avg_rot_error_deg, epoch)

            writer.add_scalar("Eval/Pos_Error_mm", pos_error, epoch)
            writer.add_scalar("Eval/Rot_Error_deg", rot_error, epoch)
            writer.add_scalar("Eval/Combined_Error", pos_error + rot_error, epoch)
